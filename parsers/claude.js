...
window.IAChatExporterClaudeParser = {
   ...
   * Lanza un error controlado para indicar que la fase de soporte de Claude está pendiente.
   */
  parseChat() {
    throw new Error('El soporte para Claude.ai está planificado para la Fase 4.');
  }
};
